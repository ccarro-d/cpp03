...
/*   Updated: 2026/02/14 13:30:30 by ccarro-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string& target)
{
	if (hitPoints_ == 0)
	{
		std::cout << "ClapTrap " << name_ << " has no health points left" << std::endl;
		return;
	}
	if (energyPoints_ == 0)
	{
		std::cout << "ClapTrap " << name_ << " has no energy points left" << std::endl;
		return;
	}
